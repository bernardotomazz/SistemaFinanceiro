...
function DashboardCard(props: DashboardCardProps) {
  ...
  return (
    <div className="bg-[#F8FAFC]  shadow-sm border border-[#E2E8F0] p-4 flex flex-col justify-start rounded-xl gap-2 hover:bg-[#CAE9FF] transition-colors duration-100">
